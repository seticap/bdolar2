const FooterPage = () => {
  return (
    <footer className="bg-custom-colortwo p-4 text-white text-center text-xs sm:text-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-12 py-6 max-w-6xl mx-auto px-4 md:px-0">
        {/* Columna Políticas */}
        <div className="mb-4 md:mb-0">
          ...
          <ul className="list-disc list-inside text-gray-300 space-y-1 text-left md:text-center lg:text-left">
            <li className="text-xs md:text-sm">Política de Privacidad y Tratamiento de Datos Personales</li>
            <li className="text-xs md:text-sm">Términos y Condiciones de Uso</li>
          </ul>
        </div>

        {/* Columna Mapa del sitio */}
        <div className="mb-4 md:mb-0">
          <h3 className="text-base md:text-lg font-semibold mb-2">Mapa del sitio</h3>
          <ul className="list-disc list-inside text-gray-300 space-y-1 text-left md:text-center lg:text-left">
        ...
        {/* Columna Contacto */}
        <div>
          <h3 className="text-base md:text-lg font-semibold mb-2">Contáctenos</h3>
